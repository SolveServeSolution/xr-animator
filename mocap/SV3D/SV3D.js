...
(function () {
  ...
  SV3D.image_obj.src = toFileProtocol((SV3D.gallery_init()) ? SV3D.gallery[0].path : Settings.f_path + '\\assets\temp\\00.jpg')

  SV3D._wood = new Image()
  SV3D._wood.src = toFileProtocol(Settings.f_path + '\\assets\temp\\wood.jpg')
