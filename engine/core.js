...
// use encodeURI instead of encodeURIComponent
    ...
    shortcut.TargetPath = System.Gadget.path + '\\platform/html/SystemAnimator_ie.hta';
    shortcut.Arguments = '"' + f_path + '"';
  }
...
(function () {
  ...
  if (browser_native_mode && !webkit_mode) {
    ...
    document.write(
  '<script type="text/javascript" language="javascript" src="platform/SA_webkit.js"></scr'+'ipt>\n'
 ,'<script src="vendor/jsmediatags.js"></scr'+'ipt>\n'
    )
...
//Settings_default._custom_.UseAudioFFTLiveInput = "non_default"
  ...
  if (xul_mode) {
    ...
    ie9 = ie9_mode = ie8_mode = true
    document.write(
  '<script type="text/javascript" language="javascript" src="platform/SA_xul.js"></scr'+'ipt>\n'
+ '<script type="text/javascript" language="javascript" src="engine/file_io.js"></scr'+'ipt>\n'
    )
    return
  }
...
//      self.jsmediatags = parent.jsmediatags
      ...
      document.write(
  '<script src="plugins/audio/aurora.js"></scr'+'ipt>\n'
+ '<script src="plugins/audio/mp3.js"></scr'+'ipt>\n'
+ '<script src="plugins/audio/aac.js"></scr'+'ipt>\n'
+ '<script src="plugins/audio/aurora_web_audio.js"></scr'+'ipt>\n'
+ '<script src="vendor/jsmediatags.js"></scr'+'ipt>\n'
