...
for (var i = 0; i < 5; i++)
  MMD_SA_options.motion.push({path:'assets/models/motion/motion_basic_pack01.zip#/_number_meter_' + (i+1) + '.vmd', jThree_para:{}, match:{skin_jThree:/^(\u5DE6)(\u80A9|\u8155|\u3072\u3058|\u624B\u9996|\u624B\u6369|.\u6307.)/}})
for (var i = 0; i < 5; i++)
  MMD_SA_options.motion.push({path:'assets/models/motion/motion_basic_pack01.zip#/_number_meter_' + (i+1) + '.vmd', jThree_para:{}, match:{skin_jThree:/^(\u53F3)(\u80A9|\u8155|\u3072\u3058|\u624B\u9996|\u624B\u6369|.\u6307.)/}})
...
//       ,motion_index: 1
     ...
     ,motion: {path:'assets/models/motion/motion_basic_pack01.zip#/_kiss2_blush_v02.vmd', match:{all_morphs:true, skin_jThree:true, morph_jThree:true}}
    }
...
//       ,motion_index: 2
     ...
     ,motion: {path:'assets/models/motion/motion_basic_pack01.zip#/_cover_undies_blush.vmd', match:{bone_group:["腕","指"], all_morphs:true, skin_jThree:/^(\u5DE6|\u53F3)(\u80A9|\u8155|\u3072\u3058|\u624B\u9996|\u624B\u6369|.\u6307.)/, morph_jThree:true}}
...
this.bubbles = [
  {
    image_url:System.Gadget.path+'/assets/images/SB_kakukaku01.png'
...
//   ,column_max_unicode: 25
  ...
  {
    image_url:System.Gadget.path+'/assets/images/SB_irregular01.png'
   ,font: '"Segoe Print",fantasy'
   ,font_unicode: 'DFKai-SB,"Microsoft JhengHei"'
   ,font_size: 18
//   ,column_max: 36-3
//   ,column_max_unicode: 18
  ...
  {
    image_url:System.Gadget.path+'/assets/images/SB_mokumoku01.png'
   ,font: '"Segoe Print",fantasy'
   ,font_unicode: 'DFKai-SB,"Microsoft JhengHei"'
   ,font_size: 18
//   ,column_max: 42-3
//   ,column_max_unicode: 21
  ...
  {
    image_url:System.Gadget.path+'/assets/images/SB_mokumoku01a.png'
   ,font: '"Segoe Print",fantasy'
   ,font_unicode: 'DFKai-SB,"Microsoft JhengHei"'
   ,font_size: 18
//   ,column_max: 42-3
...
// https://github.com/mrdoob/three/issues/12150
...
if (!para.baseTexture)
  para.baseTexture = System.Gadget.path + '/assets/images/bg.png'
...
// update default
        ...
        try {
          var f = FSO_OBJ.OpenTextFile(System.Gadget.path + '\\assets\temp\\MMD_MME_by_model.json', 2, true);
...
// https://klausw.github.io/three/examples/webvr_lorenzattractor.html
...
return texture;
 ...
 ,BVHLoader: function () {
return System._browser.load_script(toFileProtocol(System.Gadget.path + ((localhost_mode || (webkit_electron_mode && /AT_SystemAnimator_v0001\.gadget/.test(System.Gadget.path))) ? '/_private/js/BVHLoader.js' : '/export/BVHLoader.min.js')));
  }

 ,VMD_FileWriter: function () {
return Promise.all([
  System._browser.load_script(toFileProtocol(System.Gadget.path + '/export/VMD_filewriter.js')),
  System._browser.load_script(toFileProtocol(System.Gadget.path + '/vendor/encoding.min.js'))
]);
  }
...
System._browser.load_file(url, function (xhr) {
  if (use_THREE_Audio) {
// https://github.com/mrdoob/three/blob/dev/src/loaders/AudioLoader.js
...
//       ,motion_command_disabled: true
  ...
  if (MMD_SA_options.Dungeon_options.combat_mode_enabled) {
    ...
    MMD_SA_options.Dungeon.item_base.power_up = {
      icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/misc_icon/superpower_64x64.png'
     ,info_short: "????"
...
//console.log(motion_para)
    ...
    MMD_SA_options.Dungeon_options.sound.push({
      url: 'D:\\My Files\\Videos\\assets\temp\\wav\\REFLECT - OP_v01.wav'
...
// sprite animator START
  ...
  { name:"explosion_purple_01", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/explosions/explosion_03_strip13_v01-min.png', col:6, row:2, frame_count:12 },
  { name:"blood_01", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/blood/blood_hit_splash-min.png', col:4, row:4, frame_count:16, scale:20 },
  { name:"hit_yellow_01", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/hit/hit_yellow_v00-min.png', col:4, row:4, frame_count:16, scale:20 },
  { name:"pointer_blue_01", url:System.Gadget.path+'/assets/images/_dungeon/item_icon.zip#/misc_icon/arrow_down_blue_128x128.png', col:1, row:1, frame_count:1, scale:2 },

  { name:"explosion_red_01", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/explosions/explosion_01_strip13_v01-min.png', col:6, row:2, frame_count:12 },
  { name:"explosion_sinestesia-01_03",  url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/explosions/explosion_sinestesia-01_03_v01-min.png', col:4, row:8, frame_count:32, scale:20, blending:"additive" },
  { name:"_explosion_sinestesia-01_03", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/explosions/explosion_sinestesia-01_03_v01-min.png', col:4, row:8, frame_count:32, scale:20, blending:"subtractive",
texture_variant: {
  id: "BW",
...
//color.r * 0.2126 + color.g * 0.7152 + color.b * 0.0722
  ...
  { name:"thunder_particle", url:System.Gadget.path+'/assets/images/sprite_sheet.zip#/thunder/thunder_particle' + ((webkit_transparent_mode) ? '-transparent' : '') + '_v01-min.png', col:4, row:2, frame_count:8, scale:3, blending:(webkit_transparent_mode)?null:"additive" },
...
this.txr_preload_list = {
  "aura01_TXR": { url:System.Gadget.path + '/assets/images/sprite_sheet.zip#/texture/shockwave' + ((webkit_transparent_mode) ? '-transparent' : '') + '_min.png' },
};
        },
// init_3D
        function () {
...
loader.loadWithAnimation(
  ...
  url,
System.Gadget.path + '/assets/models/motion/demo/after_school_stride/after_school_stride.vmd',
...
// https://github.com/mrdoob/three/wiki/Migration-Guide#151--152
...
// r149 => r150
// https://github.com/mrdoob/three/wiki/Migration-Guide#r149--r150
...
if (!MMD_SA_options.MMD_disabled) {
  ...
  if (!MMD_SA_options.THREEX_options.model_path) {
    MMD_SA_options.THREEX_options.model_path = System.Gadget.path + '/three/model/AliciaSolid.zip#/AliciaSolid.vrm'
...
// May 5, 2025
const _Pass = await import(System.Gadget.path + '/three/postprocessing/Pass.js');
Pass = _Pass.Pass;

const EffectComposer = await import(System.Gadget.path + '/three/postprocessing/EffectComposer.js');

// not using commit from Aug 23, 2023 as it breaks MSAA/DoF
const RenderPass = await import(System.Gadget.path + '/three/postprocessing/RenderPass.js');

// Apr 4, 2025
const ShaderPass = await import(System.Gadget.path + '/three/postprocessing/ShaderPass.js');
...
//THREE.SMAAPass = (await import(System.Gadget.path + '/three/postprocessing/SMAAPass.js')).SMAAPass;

// Apr 4, 2025
THREE.OutputPass = (await import(System.Gadget.path + '/three/postprocessing/OutputPass.js')).OutputPass;
...
//console.log(effectController)
            ...
            init: async function () {
const BokehShader = await import(System.Gadget.path + '/three/shaders/BokehShader2.js');
...
//console.log(effectController_vrm)
            ...
            init: async function () {
const N8AO = await import(System.Gadget.path + '/three/postprocessing/N8AO.js');
...
//console.log(params_vrm)
            ...
            init: async function () {
const UnrealBloomPass = await import(System.Gadget.path + '/three/postprocessing/UnrealBloomPass.js');
...
// https://github.com/mrdoob/three/wiki/Migration-Guide#154--155
...
gui.controllers.forEach(c=>{
  ...
  if (typeof c != 'function')
    c.setValue(v);
      ...
      init: async function () {
const GUI = await import(System.Gadget.path + '/three/libs/lil-gui.module.min.js');
THREE.GUI = GUI.GUI;
...
//await System._browser.load_script('./three/three.min.js');

const THREE_module = await import(System.Gadget.path + '/three/' + threeX.three_filename);
self.THREE = {};
Object.assign(self.THREE, THREE_module);

const Geometry_module = await import(System.Gadget.path + '/three/Geometry.js');
...
// Jun 10, 2023
  const OutlineEffect_module = await import(System.Gadget.path + '/three/effects/OutlineEffect.js');
  Object.assign(self.THREE, OutlineEffect_module);
  console.log('OutlineEffect.js loaded')
}

if (MMD_SA_options.THREEX_options.use_MMD) {
  const MMD_module = await import(System.Gadget.path + '/three/loaders/MMDLoader.js');
  ...
  if (MMD_SA_options.THREEX_options.use_MMDAnimationHelper) {
    const MMDAnimationHelper_module = await import(System.Gadget.path + '/three/animation/MMDAnimationHelper.js');
...
// May 14, 2025
const GLTFLoader_module = await import(System.Gadget.path + '/three/loaders/GLTFLoader.js');
Object.assign(self.THREE, GLTFLoader_module);

//const GLTFExporter_module = await import(System.Gadget.path + '/three/exporters/GLTFExporter.js');
//Object.assign(self.THREE, GLTFExporter_module);

// three-vrm 1.0
if (use_VRM1) {
//  await System._browser.load_script('./three/three-vrm.min_OLD.js');
  const three_vrm_module = await System._browser.load_script(System.Gadget.path + '/three/three-vrm.module.min.js', true);
  Object.assign(self.THREE, three_vrm_module);
}
else {
  await System._browser.load_script('./three/three-vrm.min_v0.6.11.js');
}
...
if (!self.THREEX) {
  ...
  const THREE_module = await System._browser.load_script(System.Gadget.path + '/three/' + threeX.three_filename, true);
  self.THREE = {};
  Object.assign(self.THREE, THREE_module);
...
// May 24, 2025
const FBXLoader_module = await System._browser.load_script(System.Gadget.path + '/three/loaders/FBXLoader.js', true);
...
// https://www.npmjs.com/package/@pixiv/three-vrm-animation?activeTab=code
  if (!THREEX.createVRMAnimationClip) {
    const three_vrma_module = await System._browser.load_script(System.Gadget.path + '/three/three-vrm-animation.module.min.js', true);
...
// May 18, 2025
const GLTFExporter_module = await System._browser.load_script(System.Gadget.path + '/three/exporters/GLTFExporter.js', true);
...
const module_bvh2vrma = await System._browser.load_script(System.Gadget.path+'/three/bvh2vrma/convertBVHToVRMAnimation.js',true);
...
System._browser.save_file(filename+'.vrma', vrmaBuffer, 'application/octet-stream');
      ...
      export_FBX_mixamo: (()=>{
        ...
        return async function (seamSeconds) {
          ...
          const bvh = BVHLoader_inst.parse(bvh_txt);
...
const Octree_module = await System._browser.load_script(System.Gadget.path + '/three/math/Octree.js', true);
...
EXRLoader = await System._browser.load_script(System.Gadget.path + '/three/loaders/EXRLoader.js', true);
EXR_loader = new EXRLoader.EXRLoader();

RGBELoader = await System._browser.load_script(System.Gadget.path + '/three/loaders/RGBELoader.js', true);
...
// https://github.com/mrdoob/three/blob/master/examples/webgl_materials_envmaps_exr.html
...
'-i', src, '-vf', 'fps=30, scale=if(gte(iw\\,ih)\\,min(1920\\,iw)\\,-2):if(lt(iw\\,ih)\\,min(1920\\,ih)\\,-2)', '-qscale:v', '2', 'assets/temp/output_%05d.' + ((converter_image_format == 'png') ? 'png' : 'jpg')
    ]);
...
'-framerate', '30', '-i', 'assets/temp/_XRA_/xra-3d-wallpaper_output_%05d.' + converter_image_format.replace('jpeg','jpg'), '-c:v', 'libx264', '-r', '30', '-pix_fmt', 'yuv420p', '-b:v', '15M', output_file
    ]);
...
//  MMD_SA_options._Wallpaper3D_status_ = '(🌐Loading Transformers.js...)';
  transformers_worker = new Worker('mocap/transformers_worker.js', {type: 'module'});
...
// https://github.com/mrdoob/three/issues/26183
...
//  MMD_SA_options.model_para_obj.motion_name_default_combat = MMD_SA_options.model_para_obj.motion_name_default
  ...
  if (!MMD_SA_options.motion)
    MMD_SA_options.motion = [{path:System.Gadget.path + '/assets/models/motion/stand.vmd'}]
...
return this.model_para_obj.MME || this._MME
  ...
  try {
    var _file = FSO_OBJ.OpenTextFile(System.Gadget.path + '\\assets\temp\\MMD_MME_by_model.json', 1);
...
const para = { map:MMD_SA.load_texture(System.Gadget.path + '/assets/images/kiss_mark_red_o66.png'), depthTest:false };
if (!MMD_SA.THREEX.enabled) {
...
// https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script/type/importmap
  const import_map = {
    'imports': {
      'three': './three/' + MMD_SA.THREEX.three_filename,
      './libs/': './three/libs/',
      './curves/': './three/curves/',
      './math/': './three/',
      './postprocessing/': './three/postprocessing/',
      './shaders/': './three/shaders/',
    }
  };
...
'</scr'+'ipt>\n',
  ...
  // media control
  document.write('<script language="JavaScript" src="engine/SA_media_control.js"></scr'+'ipt>');

  document.write('<script language="JavaScript" src="plugins/audio/audio_BPM.js"></scr'+'ipt>');
...
if (returnBoolean("UseMatrixRain") || use_MatrixRain) {
  use_MatrixRain = true
  document.write('<script language="JavaScript" src="plugins/effects/canvas_matrix_rain.js"></scr'+'ipt>');
}

// WebGL 2D
var use_WebGL_2D// = false
if (use_WebGL_2D) {
  document.write('<script language="JavaScript" src="engine/html5_webgl2d.js"></scr'+'ipt>');
}
