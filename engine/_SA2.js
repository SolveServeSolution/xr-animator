...
(function () {
  if (EQP_gallery)
    document.write('<script language="JavaScript" src="plugins/effects/EQP_gallery.js"></scr'+'ipt>')

  if (use_EQP_ripple || use_EQP_fireworks) {
    document.write('<script language="JavaScript" src="plugins/effects/EQP_canvas_effects_core.js"></scr'+'ipt>')
  ...
  if (use_SVG_Clock)
    document.write('<script language="JavaScript" src="engine/svg_clock.js"></scr'+'ipt>')
  ...
  if (Settings.UseAudioFFT)
    document.write('<script language="JavaScript" src="plugins/audio/audio_fft.js"></scr'+'ipt>')
  ...
  if (Settings.CSSTransform3DBoxAnimate)
    document.write('<script language="JavaScript" src="engine/box3d.js"></scr'+'ipt>')

  if (!is_SA_child_animation && returnBoolean("UseWebcamHeadtracking"))
    document.write('<script language="JavaScript" src="mocap/headtracker_ar.js"></scr'+'ipt>')
...
//console.log(GetImageSize("assets/images/bg_abstract_1024x1024.jpg"))
    }
    catch (err) { console.error(err) }
  }
  else {
