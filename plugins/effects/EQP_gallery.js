...
// CORE
document.write('<script language="JavaScript" src="plugins/effects/EQP_core.js"></scr'+'ipt>');


// Pixastic
var use_Pixastic=true
if (ie9_mode && use_Pixastic) {
  document.write('<script language="JavaScript" src="plugins/effects/pixastic.js"></scr'+'ipt>');
  document.write('<script language="JavaScript" src="plugins/effects/pixastic_noise.js"></scr'+'ipt>');
  document.write('<script language="JavaScript" src="plugins/effects/pixastic_sepia.js"></scr'+'ipt>');
//  document.write('<script language="JavaScript" src="plugins/effects/pixastic_pointillize.js"></scr'+'ipt>');
  document.write('<script language="JavaScript" src="plugins/effects/pixastic_hsl.js"></scr'+'ipt>');
}
else
  use_Pixastic = false
...
if (use_Silverlight) {
  if (use_HTML5) {
    document.write('<script language="JavaScript" src="engine/html5.js"></scr'+'ipt>');
    document.write('<script language="JavaScript" src="plugins/audio/audio_BPM.js"></scr'+'ipt>');
  }
  else {
    document.write('<script language="JavaScript" src="vendor/Silverlight.js"></scr'+'ipt>');
    document.write('<script language="JavaScript" src="platform/SA_silverlight.js"></scr'+'ipt>');
  }
}
