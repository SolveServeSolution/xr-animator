...
//https://stackoverflow.com/questions/14340894/create-xml-in-javascript
        ...
        doc.load("assets/temp/song_bpm.xml");
      }
...
if (!browser_native_mode)
  ao.song_bpm_save_timerID=null; so.xml.save("assets/temp/song_bpm.xml"); DEBUG_show("(BPM info saved)", 2);
//        }, 2000)
      }
    }
    doc = so.xml
...
// https://www.electronjs.org/docs/breaking-changes#default-changed-contextisolation-defaults-to-true
  ...
  win_BPM.loadURL(toFileProtocol(System.Gadget.path + '\\platform/html/audio_BPM_detection_portable.html') + "?file=" + encodeURIComponent(DragDrop._item.path) + ((vo.audio_obj.BPM_by_id3) ? "&BPM_by_id3=" + vo.audio_obj.BPM_by_id3 : "") + ((is_SA_child_animation) ? "&window_id=" + SA_child_animation_id: ""))
...
// required
document.write('<script language="JavaScript" src="plugins/audio/audio_BPM_detection_portable.js"></scr'+'ipt>');
//document.write('<script language="JavaScript" src="plugins/audio/audio_custom_source.js"></scr'+'ipt>');
