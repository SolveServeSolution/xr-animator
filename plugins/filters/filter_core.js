...
if (self.use_spotlight)
  document.write('<script language="JavaScript" src="plugins/filters/spotlight.js"></scr'+'ipt>')
if (self.use_motionblur)
  document.write('<script language="JavaScript" src="plugins/filters/motionblur.js"></scr'+'ipt>')
if (self.use_matrix)
  document.write('<script language="JavaScript" src="plugins/filters/matrix.js"></scr'+'ipt>')
if (self.use_ghosting)
  document.write('<script language="JavaScript" src="plugins/filters/ghosting.js"></scr'+'ipt>')
if (self.use_EQ_filter)
  document.write('<script language="JavaScript" src="plugins/filters/EQ.js"></scr'+'ipt>')


if (self.use_MMG)
  document.write('<script language="JavaScript" src="plugins/filters/mmg.js"></scr'+'ipt>')
