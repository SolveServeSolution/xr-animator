...
System._browser.load_file(System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/inventory/RarityBorders/mono_L-50_V11.png', item_border.inactive)
item_border.normal = new Image()
System._browser.load_file(System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/inventory/RarityBorders/monoV11.png', item_border.normal)
...
//    tex_head +=
//  '<txr id="waveNoiseTexture" src="' + toFileProtocol(System.Gadget.path + "/assets/images/watershader_cloud.png") + '" />\n';
    tex_list.push({ tag:'txr', id:'waveNoiseTexture', src:System.Gadget.path + "/assets/images/watershader_cloud.png", para:{} });
}
...
if (!options.sound.some(function(s){return(s.name=="interface_item_access")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/interface/interface1.aac"
...
if (!options.sound.some(function(s){return(s.name=="interface_item_deny")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/interface/interface6.aac"
...
if (!options.sound.some(function(s){return(s.name=="interface_item_drop")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/interface/interface3.aac"
...
if (!options.sound.some(function(s){return(s.name=="footstep_default")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/251788__vkproduktion__footstep-01-mono.aac"
...
if (!options.sound.some(function(s){return(s.name=="footstep_water")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/270429__littlerobotsoundfactory__footstep-water-03.aac"
   ,name: "footstep_water"
   ,channel: "SFX"
   ,can_spawn: true
  });
...
if (!options.sound.some(function(s){return(s.name=="footstep_grass")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/456273__soundfx-studio__footsteps-grass.aac"
   ,name: "footstep_grass"
   ,channel: "SFX"
   ,can_spawn: true
  });
...
if (!options.sound.some(function(s){return(s.name=="footstep_sand")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/456273__soundfx-studio__footsteps-sand.aac"
   ,name: "footstep_sand"
   ,channel: "SFX"
   ,can_spawn: true
  });
...
if (!options.sound.some(function(s){return(s.name=="car_engine01")})) {
  options.sound.push({
    url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/car_engine_loop_5x5.aac"
   ,name: "car_engine01"
   ,channel: "SFX"
   ,can_spawn: true
   ,loop: true
...
if (options.use_PC_click_reaction_default) {
  ...
  if (!options.sound.some(function(s){return(s.name=="hit-1")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/162370__lewisisminted__punch-1.aac"
     ,name: "hit-1"
     ,channel: "SFX"
     ,can_spawn: true
    });
  ...
  if (!options.sound.some(function(s){return(s.name=="hit-3")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/104183__ekokubza123__punch.aac"
     ,name: "hit-3"
     ,channel: "SFX"
     ,can_spawn: true
    });
  ...
  if (!options.sound.some(function(s){return(s.name=="anime_wow")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/Anime_Wow_Sound.oga"
     ,name: "anime_wow"
     ,channel: "SFX"
//     ,can_spawn: true
    });
...
return ((this.frame >= 27) ? 0 : (27 - this.frame)/27)
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/hit/h01_何かにぶつかる小.vmd', match:{skin_jThree:{ test: function(name) { return !((name=='センター') || (name=='上半身') || (name=='下半身') || (name.indexOf("ＩＫ") != -1) || (/^(\u5DE6|\u53F3)(\u8DB3|\u3072\u3056)/.test(name))); } }, morph_jThree:{test:function(name){ return (name!="瞳小") }} }}
...
if (MMD_SA._hit_chest_) {
  ...
  this._cover_chest_=false
   ...
   ,motion: {path:'assets/models/motion/motion_basic_pack01.zip#/cover_chest_v02b.vmd', match:{bone_group:["腕","指"], all_morphs:true, skin_jThree:/^(\u5DE6|\u53F3)(\u80A9|\u8155|\u3072\u3058|\u624B\u9996|\u624B\u6369|.\u6307.)/, morph_jThree:true}}
...
if (options.combat_mode_enabled) {
  ...
  if (!options.sound.some(function(s){return(s.name=="hit-2")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/216198__rsilveira-88__cartoon-punch-02.aac"
     ,name: "hit-2"
     ,channel: "SFX"
     ,can_spawn: true
    });
  ...
  if (!options.sound.some(function(s){return(s.name=="swing")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/battle/swing.aac"
     ,name: "swing"
     ,channel: "SFX"
     ,can_spawn: true
    });
  ...
  if (!options.sound.some(function(s){return(s.name=="hit_slash")})) {
    options.sound.push({
      url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/35213__abyssmal__slashkut.aac"
     ,name: "hit_slash"
     ,channel: "SFX"
     ,can_spawn: true
    });
...
if (sd) {
  if (!sd.texture_path_list)
    sd.texture_path_list = [System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/angel_staircase.jpg"]
...
// floor
 ,{
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_COLOR_AO-50.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_NRM_c80.jpg"
 ,specularMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_SPEC_c80.jpg"
// ,displacementMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_DISP_256x256.png"
...
// wall
 ,{
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_COLOR_AO.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_NRM_c80.jpg"
 ,specularMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_SPEC_c90.jpg"
// ,displacementMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_DISP_256x256.png"
...
this.item_base._empty_ = Object.assign({
  icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/empty.gif'
 ,rarity: "inactive"
 ,info_short: "Empty"
}, this.item_base._empty_||{});

this.item_base._backpack_ = Object.assign({
  icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/fantasy_icon/backpack_64x64.png'
...
// ,is_always_visible: true
 ...
 ,sound: [
    {
  url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/interface/interface2.aac"
 ,name: "item_backpack"
 ,is_drag: true
    }
  ]
...
this.icon_path = System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/misc_icon/bag_64x64.png';
this.info_short = "Bag";
...
this.item_base._map_ = Object.assign({
  icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/fantasy_icon/map_64x64.png'
 ,info_short: "Map"
...
this.item_base.menu = Object.assign({
  icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/fantasy_icon/tome_64x64.png'
 ,info_short: "Tome (Menu)"
 ,index_default: MMD_SA_options.Dungeon.inventory.max_base
 ,stock_max: 1
 ,sound: [
    {
  url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPGsounds_Kenney/bookOpen.ogg"
 ,name: "item_book_open"
 ,is_drag: true
    }
  ]
...
if (!this.item_base.coin) {
  this.item_base.coin = {
    icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/fantasy_icon/coin_64x64.png'
   ,info_short: "Gold Coin"
   ,stock_max: 999999
   ,sound: [
      {
  url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/inventory/coin3.aac"
 ,name: "item_coin"
 ,is_drag: true
 ,is_no_action: true
      }
...
if (!this.item_base.potion_hp_50) {
  this.item_base.potion_hp_50 = {
    icon_path: System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/potions/pt1_64x64.png'
   ,info_short: "HP Potion (M)"
   ,stock_max: 9
   ,sound: [
      {
  url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/inventory/bubble2.aac"
 ,name: "item_potion_drink01"
      }
     ,{
  url: System.Gadget.path + "/assets/sound/SFX_pack01.zip#/RPG Sound Pack/inventory/bottle.aac"
 ,name: "item_potion01"
 ,is_drag: true
      }
    ]
...
[
  System.Gadget.path + '/assets/images/_dungeon/item_icon.zip#/inventory/BlankSlot.png'
...
// NOTE: I give up changing the mesh collision system to work with x/z rotation of the object (for now at least). It requires too many changes on existing codes, especially the part to get ground_y.
  ...
  if (that.use_octree) {
// https://github.com/mrdoob/three/blob/master/examples/games_fps.html
...
// https://github.com/mrdoob/three/issues/5587
    vectorMouse.set(
...
this.motion["PC default"] = Object.assign({
  path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/tsuna/tsuna_standby.vmd',
...
this.motion["PC movement forward"] = Object.assign({
  path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/walk_n_run/run_H57_f0-20.vmd',
  para: { adjust_center_view_disabled:true, loop_on_blending:true, onended: function () { MMD_SA._no_fading=true; },
...
/*
  this.motion["PC movement forward"] = { path:System.Gadget.path + '/assets/models/motion/walk_n_run/run_H45_f0-360.vmd',
...
if (!this.motion["PC forward jump"]) {
  this.motion["PC forward jump"] = { path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/tsuna/tsuna_small_jump.vmd',
...
if (!this.motion["PC high jump"]) {
  this.motion["PC high jump"] = { path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/landing/05_magical_jump_v01.vmd',
...
if (!this.motion["PC landing"]) {
  this.motion["PC landing"] = { path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/landing/04_deep_landing.vmd',
...
if (!this.motion["NPC talk A"]) {
  this.motion["NPC talk A"] = { path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/talk/xs-talk8-west-negotiate.vmd'
   ,para: {
...
if (!this.motion["NPC walk A"]) {
  this.motion["NPC walk A"] = { path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/walk_n_run/walk_A01_f0-40_s9.85.vmd' };
}
if (!this.motion["PC fall on ass"]) {
  this.motion["PC fall on ass"] = { path:'assets/models/motion/motion_rpg_pack01.zip#/hit/w01_すべって尻もち.vmd'
   ,para:{
...
if (!this.motion["PC stand up from ass"]) {
  this.motion["PC stand up from ass"] = { path:'assets/models/motion/motion_rpg_pack01.zip#/casual/女の子座り→立ち上がる_gumi_v01.vmd'
   ,para: {
...
if (!this.motion["PC fall from trip"]) {
  this.motion["PC fall from trip"] = { path:'assets/models/motion/motion_rpg_pack01.zip#/hit/r01_普通に転ぶ.vmd'
...
if (!this.motion["PC stand up from face down"]) {
  this.motion["PC stand up from face down"] = { path:'assets/models/motion/motion_rpg_pack01.zip#/casual/OTL→立ち上がり.vmd'
...
//bone_group:["腕","指"]
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション３/2-handed_weapon_arms.vmd', match:{skin_jThree:RE_skin_jThree, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
 ,{
    action: {
      condition: function (is_bone_action, objs) {
...
return RE_parry.test(motion_id) && two_handed_weapon_equipped(objs._model_index);
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション３/2-handed_weapon_guard.vmd', match:{skin_jThree:{ test: function(name) { return ((name=='上半身') || RE_skin_jThree.test(name)); } }, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
...
// bone_group is possibly useful only if .copy_first_bone_frame is used
//bone_group:["腕","指"]
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション５/1-handed_weapon_arms.vmd', match:{skin_jThree:RE_skin_jThree, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
 ,{
    action: {
      condition: function (is_bone_action, objs) {
...
return RE_parry.test(motion_id) && one_handed_weapon_equipped(objs._model_index);
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション５/1-handed_weapon_guard.vmd', match:{skin_jThree:{ test: function(name) { return (RE_skin_jThree_one_handed_guard.test(name) || RE_skin_jThree.test(name)); } }, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
...
return MMD_SA_options.Dungeon.character.combat_mode && RE_arms.test(motion_id) && twin_weapon_equipped(objs._model_index);
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション４/twin_weapon_arms.vmd', match:{skin_jThree:RE_skin_jThree, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
 ,{
    action: {
      condition: function (is_bone_action, objs) {
...
return RE_parry.test(motion_id) && twin_weapon_equipped(objs._model_index);
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション４/twin_weapon_guard.vmd', match:{skin_jThree:{ test: function(name) { return ((name=='上半身') || RE_skin_jThree.test(name)); } }, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
...
return one_handed_weapon_equipped(objs._model_index);
   ...
   ,motion: {path:'assets/models/motion/motion_rpg_pack01.zip#/粗製のモーション５/hand_R_weapon_hold.vmd', match:{skin_jThree:RE_skin_jThree_hand_R, morph_jThree:false}, para_SA:{model_index_list:MMD_SA_options.Dungeon.battle_model_index_list}}
  }
);
  })();
...
if (!this.motion["DUMMY"]) {
  this.motion["DUMMY"] = {
    path: "assets/models/motion/motion_basic_pack01.zip#/center_dummy.vmd"
   ,para: {
      model_name_RegExp: {
...
if (self._js_min_mode_ || (browser_native_mode && !webkit_window && !localhost_mode)) {
  ...
  document.write('<script language="JavaScript" src="plugins/dungeon/dungeon.core.min.js"></scr'+'ipt>');
}
else {
  document.write('<script language="JavaScript" src="vendor/mersenne-twister.js"></scr'+'ipt>');
  document.write('<script language="JavaScript" src="plugins/dungeon/dungeon-generator.js"></scr'+'ipt>');
  document.write('<script language="JavaScript" src="plugins/dungeon/terrain.js"></scr'+'ipt>');

  document.write('<script language="JavaScript" src="vendor/rbush.min.js"></scr'+'ipt>');
//document.write('<script language="JavaScript" src="node_modules/box-intersect.js"></scr'+'ipt>');

  document.write('<script language="JavaScript" src="vendor/nipplejs.js"></scr'+'ipt>');
}
