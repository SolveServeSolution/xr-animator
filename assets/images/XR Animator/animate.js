...
//  { path:System.Gadget.path + '/assets/models/motion/swing.vmd'}
  { must_load:true, no_shuffle:true, path:System.Gadget.path + '/assets/models/motion/motion_basic_pack01.zip#/standmix2_modified.vmd'}
...
//    model_path: 'C:\\Users\\user\\Downloads\\EL-Pr213-BosaHair\\EL-Pr213-BosaHair\\ボサ髪_v01.pmx'//'C:\\Users\\user\\Downloads\\iroha+kazama+v1.0\\iroha kazama v1.0\\model\\iroha kazama ver1.0.pmx'//System.Gadget.path + '/assets/temp/DEMO/models/AvatarSample_A.vrm'
...
//  Settings_default._custom_.Use60FPS = "non_default"
  ...
  if (!webkit_electron_mode)
    self.SA_wallpaper_src = System.Gadget.path + "/assets/images/wood_wallpaper_flip-h.jpg";
...
MMD_SA_options.Dungeon_options = {
 ...
 ,motion: {
    "PC movement forward": {
  path:System.Gadget.path + '/assets/models/motion/motion_rpg_pack01.zip#/walk_n_run/run_H01_f0-24.vmd',
  para_SA: {
    adjust_center_view_disabled: false,
...
/*
    {
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Sand 002/Sand 002_COLOR_AO.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Sand 002/Sand 002_NRM_c80.jpg"
 ,specularMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Sand 002/Sand 002_SPEC_c80.jpg"
...
var panorama_list = [
  ...
  System.Gadget.path + '/assets/images/_dungeon/tex/stars_milky_way.jpg',
];
...
async function change_HDRI(index, use_background) {
  ...
  await MMD_SA.THREEX.utils.HDRI.load(System.Gadget.path + '/assets/images/_dungeon/hdri/' + ((use_background)?'full/':'') + HDRI_list[index-1], use_background);
  ...
  async function parse_scene(json, scene_src) {
    async function locate_file(zip, obj, type) {
      ...
      switch (obj.path.replace(/^.+[\/\\]/, '').replace(/\.js$/i, '')) {
        case 'scene_auto_fit':
          obj.path = System.Gadget.path + '\\engine\\scene_auto_fit.js';
          return true;
      }
...
setTimeout(()=>{
  System._browser.load_script(toFileProtocol(System.Gadget.path + '/export/BVH_filewriter.js')).then(()=>{
...
//  System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/angel_staircase.jpg"
//  System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/blue_sky.jpg"
//  System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/unknown_planet_v00_c95.jpg"
