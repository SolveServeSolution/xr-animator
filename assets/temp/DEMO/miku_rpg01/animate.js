...
//  model_path: System.Gadget.path + '\\assets\temp\\DEMO\\models\\chung.min.zip#\\_chung_v012_CLEANED-v03.pmx'
//  model_path: System.Gadget.path + "/assets/temp/DEMO/models/miss_foo.zip#/_MissFoo_v09b_for_SA-CLEANED_v01.pmx"
  model_path: System.Gadget.path + '\\assets\temp\\DEMO\\models\\Appearance Miku.min.zip#\\Appearance Miku_BDEF_mod-v05.pmx'
/*
 ,model_path_extra: [
...
return function (model) {
 ...
 ,icon_path: System.Gadget.path + '/assets/images/icon_miku_64x64.png'
    }
...
return function (v) { return !(/X\-JOINT/.test(v) || (skin_list.indexOf(v) != -1)); };
 ...
 ,icon_path: System.Gadget.path + "/assets/temp/DEMO/_chung_icon_64x64.png"
}
...
//  { path:System.Gadget.path + '/assets/models/motion/tsuna/standby.vmd'}
null
//  { path:Settings.f_path + '/motion/_sleep90.vmd'}

   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/magic_of_xyz/magic_of_xyz.vmd'
    }
   ...
   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/suki_yuki_maji_magic/suki_yuki_maji_magic.vmd'
    }

   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/galaxias_motion/galaxias_miku_v2.vmd'
    }
...
//   ,{ path:Settings.f_path + '/motion/sweetmagic-left.vmd' }
   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/STEP/1_step-motion1.vmd'
    }
...
//15
   ...
   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/mozuya/monstar.vmd'
    }

   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/mozuya/Walka_Not_A_Talka.vmd'
    }

   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/mozuya/louboutins.vmd'
    }

   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/mozuya/black_n_gold.vmd'
    }
   ...
   ,{
      path:System.Gadget.path + '/assets/models/motion/motion_demo_pack01.zip#/demo/lupin/lupin.vmd'
    }
...
(function () {
  ...
  self.SA_wallpaper_src = System.Gadget.path + "\\assets\temp\\DEMO\\bg_miku_x_teto_c50.jpg"
...
// water
   ,{
  map: System.Gadget.path + "/assets/images/watershader_water.jpg"
 ,specular:'#404040'
...
//,side:2
 ...
 ,motion: {
    "camera appeal 03": { path:System.Gadget.path + '/assets/models/motion/model/camera_appeal03.vmd' }
/*
   ,"PC default": { path:System.Gadget.path + '/assets/models/motion/tsuna/tsuna_standby.vmd', index:0, para: { adjust_center_view_disabled:true, onended: function () { MMD_SA._no_fading=true; } }}
   ,"NPC talk A": { path:System.Gadget.path + '/assets/models/motion/talk/xs-talk8-west-negotiate.vmd' }
   ,"NPC walk A": { path:System.Gadget.path + '/assets/models/motion/walk_n_run/walk_A01_f0-40_s9.85.vmd' }
*/
/*
   ,"PC sleigh default": { path:System.Gadget.path + '/assets/models/motion/standmix2_modified.vmd', para: { adjust_center_view_disabled:true, onended: function () { MMD_SA._no_fading=true; }
 ,adjustment_per_model: {
    _default_ : {
...
*/
/*
   ,"PC fall on ass": { path:'assets/models/motion/hit/w01_すべって尻もち.vmd', para:{
...
MMD_SA._ignore_physics_reset=true; MMD_SA._no_fading=true;
 ...
 ,adjustment_per_model: {
  ...
  morph_default: {"瞳小": { weight_scale:0.75 }}
   ...
   ,"PC stand up from ass": { path:'assets/models/motion/casual/女の子座り→立ち上がる_gumi_v01.vmd', para: {
...
*/
/*
   ,"PC catwalk": { path:System.Gadget.path + '/assets/models/motion/walk_n_run/walk_A34_f0-42.vmd', para: { adjust_center_view_disabled:true, onended: function () { MMD_SA._no_fading=true; } }}
...
d.object_base_list[2].object_list.forEach(function (obj) {
 ...
 ,skydome: {
    texture_path_list: [
  System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/angel_staircase.jpg"
 ,System.Gadget.path + "/assets/images/_dungeon/tex/ryntaro_nukata/blue_sky.jpg"
...
MMD_SA_options.Dungeon_options.sound = [
  {
    url: System.Gadget.path + "/assets/temp/DEMO/music/stranger_things_remix.aac"
   ,channel: "BGM_ST"
   ,loop: true
  }
]
...
// ceil
    {
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 002/Stone_Wall_002_COLOR.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 002/Stone_Wall_002_NRM.jpg"
 ,geo_by_lvl: [[1,1]]
 ,distance_by_lvl: []
    }
// floor
   ,{
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_COLOR.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Floor 003/Pavement_006_NRM.jpg"
// ,specular:'#404040'//specularMap: Settings.f_path + "\\tex\\3dtextures.me\\Stone Floor 003\\Pavement_006_SPEC.png"//
// ,displacementMap: Settings.f_path + "\\tex\\3dtextures.me\\Stone Floor 003\\Pavement_006_DISP_256x256.png"
// ,uDisplacementBias: -0.5
 ,geo_by_lvl: [[1,1]]//[[1,1],[16,16],[32,32],[128,128]]//
...
// wall
   ,{
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_COLOR_c90.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Stone Wall 004/Wall Stone 004_NRM_c90.jpg"
...
// lava
   ,{
  map: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_COLOR_1024x1024.jpg"
 ,normalMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_NRM_1024x1024.jpg"
 ,displacementMap: System.Gadget.path + "/assets/images/_dungeon/tex/3dtextures.me/Lava 001/Lava_001_DISP_256x256.png"
...
//  path: 'F:\\MMD\\stages\\空色町1.52\\sorairo1.52_v01.x'
  path: System.Gadget.path + "/assets/temp/DEMO/models/asian_town_x500.zip#/asian_town_x500_v03.x"
...
//2
   ,{
  path: System.Gadget.path + "/assets/images/_dungeon/x/SF-treasure_chest.zip#/chest_v02.x"
 ,construction: {
    receiveShadow: true
   ,castShadow: true
  }
...
//3
  ...
  construction: {
    mesh_obj: { id:"Manhole0MESH" }//, receiveShadow:true }
   ,GOML_head: [
  '<txr id="Manhole0TXR"   src="' + toFileProtocol(System.Gadget.path + '/assets/temp/DEMO/manhole_color.jpg') + '" param="repeat:1 1;" />'
//+ '<txr id="Manhole0TXR_N" src="' + toFileProtocol('F:\\MMD\\accessories\\SF-chicago-city-electric-cover\\textures\\city_elec_Normal.tga.png') + '" param="repeat:1 1;" />'
//+ '<txr id="Manhole0TXR_S" src="' + toFileProtocol('F:\\MMD\\accessories\\SF-chicago-city-electric-cover\\textures\\city_elec_Metallic.tga.png') + '" param="repeat:1 1;" />'
+ '<geo id="Manhole0GEO" type="Circle" param="' + [1,128].join(" ") + '" />'
+ '<mtl id="Manhole0MTL" type="MeshPhong" param="map:#Manhole0TXR;" />'// normalMap:#Manhole0TXR_N; specularMap:#Manhole0TXR_S; specular:#FFFFFF;" />'
...
return _grid_array
 ...
 ,sound: [
    {
      url: System.Gadget.path + "/assets/temp/DEMO/music/city-city-morning-silent-03.aac"
     ,channel: "BGM"
     ,loop: true
     ,autoplay: true
    }
...
// ,fog: {}
 ...
 ,sound: [
    {
      url: System.Gadget.path + "/assets/temp/DEMO/music/ultra_instinct-clash_of_gods_remix_yt-KJ71dY4mkNo.aac"
     ,channel: "BGM"
     ,loop: true
     ,autoplay: true
    }
...
//  System.Gadget.path + "/assets/temp/DEMO/models/mrs_ma.min.zip#/_0Ma_v06h_for_SA_v04.pmx"
  System.Gadget.path + '\\assets\temp\\DEMO\\models\\Appearance Teto IS 1.0.5.min.zip#\\Appearance Teto_IS_1.0.5_v03.pmx'

// ,System.Gadget.path + '\\assets\temp\\DEMO\\models\\chung.min.zip#\\_chung_v012_CLEANED-v03#clone1.pmx'
// ,System.Gadget.path + "/assets/temp/DEMO/models/miss_foo.zip#/_MissFoo_v09b_for_SA-CLEANED_v01.pmx"
...
addProton()
    ...
    function createSprite() {
        var map = THREE.ImageUtils.loadTexture(toFileProtocol(System.Gadget.path + '/assets/images/_fireworks/dot.png'))
...
/*
        	particleGroup = new SPE.Group({
        		texture: {
                    value: THREE.ImageUtils.loadTexture('assets/images/_fireworks/fireworks_electric.png')
                }
        	});
...
particleGroup = new ShaderParticleGroup({
	...
	texture: THREE.ImageUtils.loadTexture(toFileProtocol(System.Gadget.path + '/assets/images/_fireworks/fireworks_music_green.png')),
...
document.write('<script language="JavaScript" src="plugins/dungeon/dungeon.js"></scr'+'ipt>');
