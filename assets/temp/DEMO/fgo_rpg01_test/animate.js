...
//  model_path: System.Gadget.path + '\\assets\temp\\DEMO\\models\\★MMD宮本武蔵.min.zip#\\■宮本武蔵霊基再臨01_v01.pmx'
  model_path: System.Gadget.path + '\\assets\temp\\DEMO\\models\\巴御前  (アチャー インフェルノ).min.zip#\\巴御前  (アチャー インフェルノ) オルタネイト_v01.pmx'
...
// to make sure that every VMD has morph (at least a dummy)
 ...
 ,icon_path: System.Gadget.path + "/assets/temp/DEMO/_miyamoto_icon_64x64.png"
}
...
(function () {
  ...
  self.SA_wallpaper_src = System.Gadget.path + "\\assets\temp\\DEMO\\bg_fgo01_c50.jpg"
...
if (MMD_SA._hit_chest_) {
  ...
  MMD_SA_options.motion.push(
    { must_load:true, no_shuffle:true, path:'assets/models/motion/hit/r01_普通に転ぶ.vmd' }
   ,{ must_load:true, no_shuffle:true, path:'assets/models/motion/casual/OTL→立ち上がり.vmd' }
  );
  var _motion_para = {
...
//2
   ,{
  path: System.Gadget.path + "/assets/images/_dungeon/x/SF-treasure_chest.zip#/chest_v01.x"
 ,construction: {
    receiveShadow: true
   ,castShadow: true
  }
...
MMD_SA_options.model_path_extra = [
  System.Gadget.path + '\\assets\temp\\DEMO\\models\\Yat_FGO_Hokusai_v101.min.zip#\\00_お栄_v01.pmx'
